...
This bash script generated a report of changes including release notes
from `ReleaseNotes.txt` and code changes history files `changes.txt`
from your repository.

Example of a generated report you can see in [doc/reports](https://github.com/mir0n-pro/git-utilities/tree/main/doc/reports)

### How to install
Just copy both files onto `c:\Program Files\Git\cmd`.
...
Example: staying in the local repository, and having the batch and bash files in the `c:\mycmd` folder, you need to call
`c:\mycmd\git_gen_rep`.
